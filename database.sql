...
--
-- Host: 127.0.0.1
-- Generation Time: 11 Jun 2014 pada 11.00
-- Versi Server: 5.6.16
-- PHP Version: 5.5.9
...
(5, 'JAWA BARAT', 'DKI JAKARTA', 1, 'Active');
...
(4, 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'test', 'Active');
...
('b71cc11c2b0d924ec035cfa263390342', '::1', 'Mozilla/5.0 (Windows NT 6.1; rv:29.0) Gecko/20100101 Firefox/29.0', 1402476738, 'a:2:{s:9:"user_data";s:0:"";s:4:"user";a:4:{s:2:"id";s:1:"4";s:8:"username";s:9:"superuser";s:5:"email";s:19:"superuser@ics.co.id";s:12:"user_type_id";s:1:"1";}}');
